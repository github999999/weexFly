...
public class Progress extends View {
     ...
     * 设置圆环进度条的宽度 px
     */
    public Progress setProdressWidth(int width) {
     ...
     * @param value
     */
    public Progress setTextSize(int value) {
        textSize = value;
        return this;
    }
     ...
     *
     */
    public Progress setTextColor(int color) {
     ...
     *
     */
    public Progress setPreProgress(int precolor) {
     ...
     * @param color
     */
    public Progress setProgress(int color) {
     ...
     * @return
     */
    public Progress setCircleBackgroud(int color) {
     ...
     * @param scale
     */
    public Progress setPaddingscale(float scale) {
     ...
     */
    public Progress setStartAngle(int startAngle) {
